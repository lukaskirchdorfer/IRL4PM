...
def build_decision_dataset(
    ...
    # Include all columns for dynamic feature functions
...
# =========================================================
# 3) Train per-agent XGBoost models
# =========================================================

def train_xgboost_per_agent(
    ...
    negatives_per_pos: int = 5,
    scalers: Dict[str, Any] = None
) -> Tuple[Dict[Any, xgb.XGBClassifier], Dict[str, Dict[Any, int]]]:
    """
...
def evaluate_topk_decisions_per_agent(
    ...
    models: Dict[Any, "xgb.XGBClassifier"],
    encoders: Dict[str, Dict[Any, int]],
    numerical_features: List[str],
    categorical_features: List[str],
    ks: List[int] = [1, 2, 3],
